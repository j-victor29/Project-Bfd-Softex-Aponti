# 📹 Roteiro para Vídeo de Demonstração (30 a 60 segundos)

Este roteiro ajuda você a gravar um vídeo dinâmico e direto ao ponto para prender a atenção de recrutadores. Você pode gravá-lo usando ferramentas gratuitas como Loom, OBS Studio ou gravadores de tela integrados (Windows Game Bar).
...
## 💡 Dicas de Gravação:
1. **Prepare tudo antes:** Rode o `seed_demo` antes de gravar para que todas as informações estejam prontas e limpas.
2. **Abra múltiplas abas:** Tenha uma aba logada como Cliente, outra como Staff e outra como Artista. Isso evita que você perca tempo fazendo login durante o vídeo.
3. **Mova o mouse suavemente:** Evite movimentos bruscos. Dê foco nos botões importantes com um pequeno atraso antes de clicar.
4. **Sem áudio ou música de fundo suave:** Para o LinkedIn, vídeos rápidos com legendas ou apenas o fluxo fluindo muito rápido funcionam melhor do que áudios longos.
